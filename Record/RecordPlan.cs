...
namespace Record
{
    public partial class RecordPlan : UserControl
    {
        ...
        private static bool PlanStatusControl = FunFile.GetString(FunFile.iniAppSchd, "[RECORD]", "PlanStatusControl")[0] == "0";
        ...
        class ThisApplicationLoad
        {
            public static void CreateContextMenuStrip(DataGridViewRow ActiveRow, ComboBox cmb1, TextBox tb1, ComboBox cmb2, TextBox tb2, TextBox tb3, Button b1)
            {
                ...
                if (STATUSNAME != "完了" && STATUSNAME != "保留" || PlanStatusControl)
                {
        ...
        private void b1_Click(object sender, EventArgs e)
        {
            ...
            {
                FunSQL.SQLDML("SQLRecordPlan0010", Record.SQLRecordPlan0010, new string[] { "@GOALID", "@PLANNAME", "@PRIORID", "@PLANSTARTDATE", "@PLANENDDATE" }, new string[] { cmb1.SelectedValue.ToString(), tb1.Text, cmb2.SelectedValue.ToString(), tb2.Text, tb3.Text });
            }
            else if (b1.Text == "更新" && PLANID != "")
            {
                FunSQL.SQLDML("SQLRecordPlan0020", Record.SQLRecordPlan0020, new string[] { "@GOALID", "@PLANNAME", "@PRIORID", "@PLANSTARTDATE", "@PLANENDDATE", "@PLANID" }, new string[] { cmb1.SelectedValue.ToString(), tb1.Text, cmb2.SelectedValue.ToString(), tb2.Text, tb3.Text, PLANID });
            }
            ThisApplicationLoad.DataLoad();
            ThisApplicationCleaning.FormCleaning(tb1, tb2, tb3, b1);
        }
