...
namespace ToDo
{
    public partial class ToDoInComp : UserControl
    {
        ...
        private static bool ToDoStatusControl = FunFile.GetString(FunFile.iniAppSchd, "[TODO]", "ToDoStatusControl")[0] == "0";
        public ToDoInComp()
        {
            InitializeComponent();
        }
        ...
        {
            private static void CreateDataGridView(Panel p3, Panel p5, ComboBox cmb1, TextBox tb1, ComboBox cmb2, TextBox tb2, Button b1)
            {
            ...
            public static void ThisApplicationExec(Panel p3, Panel p5, ComboBox cmb1, TextBox tb1, ComboBox cmb2, TextBox tb2, Button b1)
            {
                CreateDataGridView(p3, p5, cmb1, tb1, cmb2, tb2, b1);
        ...
        class ThisApplicationLoad
        {
            public static void CreateContextMenuStrip(DataGridViewRow ActiveRow, ComboBox cmb1, ComboBox cmb2, TextBox tb1, TextBox tb2, Button b1)
            {
                ...
                if (STATUSNAME != "完了" && STATUSNAME != "保留" || ToDoStatusControl)
                {
        ...
        {
            ThisApplicationSetup.ThisApplicationExec(p3, p5, cmb1, tb1, cmb2, tb2, b1);
        ...
        private void b1_Click(object sender, EventArgs e)
        {
            ...
            {
                FunSQL.SQLDML("SQLToDo0010", ToDo.SQLToDo0010, new string[] { "@PLANID", "@TODONAME", "@STATUSID", "@TODOENDDATE" }, new string[] { cmb2.SelectedValue.ToString(), tb1.Text, "2", $"{tb2.Text} 00:00:00" });
            }
        ...
        private void ToDoInComp_Resize(object sender, EventArgs e)
        {
            int MAXSIZE = 720;
            int MINISIZE = 200;
