    ...
    public partial class ScheduleForm : Form
    {
        ...
        private void b1_Click(object sender, EventArgs e)
        {
            ...
            if (CheckResult)
            {
                ...
                {
                    FunSQL.SQLDML("SQLSchedule0010", Schedule.SQLSchedule0010, new string[] { "@PLANID", "@SCHEDULEDATE", "@SCHEDULESTARTTIME", "@SCHEDULEENDTIME", "@SCHEDULELOCATION", "@SCHEDULEHEIGHT" }, new string[] { cmb2.SelectedValue.ToString(), $"{tb1.Text} 00:00:00", $"{tb1.Text} {tb2.Text}:00", $"{tb1.Text} {tb3.Text}:00", SCHEDULELOCATION.ToString(), SCHEDULEHEIGHT.ToString() });
                }
                else if (b1.Text == "更新" && SCHEDULEID != "")
                {
                    FunSQL.SQLDML("SQLSchedule0020", Schedule.SQLSchedule0020, new string[] { "@PLANID", "@SCHEDULEDATE", "@SCHEDULESTARTTIME", "@SCHEDULEENDTIME", "@SCHEDULELOCATION", "@SCHEDULEHEIGHT", "@SCHEDULEID" }, new string[] { cmb2.SelectedValue.ToString(), $"{tb1.Text} 00:00:00", $"{tb1.Text} {tb2.Text}:00", $"{tb1.Text} {tb3.Text}:00", SCHEDULELOCATION.ToString(), SCHEDULEHEIGHT.ToString(), SCHEDULEID });
                }
                if (ThisFormKey == "日別")
                {
